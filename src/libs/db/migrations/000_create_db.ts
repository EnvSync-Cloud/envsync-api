...
export async function up(db: Kysely<Database>): Promise<void> {
    ...
    await db.schema
        ...
        .addColumn('created_at', 'timestamptz', (col) => col.notNull())
        .addColumn('updated_at', 'timestamptz', (col) => col.notNull())
        .addForeignKeyConstraint('fk_org_role_org_id_orgs_id', ['org_id'], 'orgs', ['id'], (cb) => cb.onDelete('cascade'))
        .execute();
    ...
    await db.schema
        ...
        .addColumn('created_at', 'timestamptz', (col) => col.notNull())
        .addColumn('updated_at', 'timestamptz', (col) => col.notNull())
        .addForeignKeyConstraint('fk_users_org_id_orgs_id', ['org_id'], 'orgs', ['id'], (cb) => cb.onDelete('cascade'))
        .addForeignKeyConstraint('fk_users_role_id_org_role_id', ['role_id'], 'org_role', ['id'], (cb) => cb.onDelete('cascade'))
        .execute();
    ...
    await db.schema
        ...
        .addColumn('created_at', 'timestamptz', (col) => col.notNull())
        .addColumn('updated_at', 'timestamptz', (col) => col.notNull())
        .addForeignKeyConstraint('fk_invite_user_org_id_orgs_id', ['org_id'], 'orgs', ['id'], (cb) => cb.onDelete('cascade'))
        .addForeignKeyConstraint('fk_invite_user_role_id_org_role_id', ['role_id'], 'org_role', ['id'], (cb) => cb.onDelete('cascade'))
        .execute();
    ...
    await db.schema
        ...
        .addColumn('created_at', 'timestamptz', (col) => col.notNull())
        .addColumn('updated_at', 'timestamptz', (col) => col.notNull())
        .addForeignKeyConstraint('fk_app_org_id_orgs_id', ['org_id'], 'orgs', ['id'], (cb) => cb.onDelete('cascade'))
        .execute();
    ...
    await db.schema
        ...
        .addColumn('created_at', 'timestamptz', (col) => col.notNull())
        .addColumn('updated_at', 'timestamptz', (col) => col.notNull())
        .addForeignKeyConstraint('fk_env_type_org_id_orgs_id', ['org_id'], 'orgs', ['id'], (cb) => cb.onDelete('cascade'))
        .execute();
    ...
    await db.schema
        .createIndex('env_store_org_id_idx')
        .on('env_store')
        .column('org_id')
        .execute();
    ...
    await db.schema
        ...
        .addColumn('created_at', 'timestamptz', (col) => col.notNull())
        .addColumn('updated_at', 'timestamptz', (col) => col.notNull())
        .addForeignKeyConstraint('fk_audit_log_org_id_orgs_id', ['org_id'], 'orgs', ['id'], (cb) => cb.onDelete('cascade'))
        .addForeignKeyConstraint('fk_audit_log_user_id_users_id', ['user_id'], 'users', ['id'], (cb) => cb.onDelete('cascade'))
        .execute();
}
