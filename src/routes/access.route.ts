...
app.get(
    ...
    describeRoute({
        ...
        summary: "Create CLI Login URL",
        description: "Generate authentication URL for CLI login",
        tags: ["Access"],
        responses: {
            201: {
                description: "CLI login URL created successfully",
                content: {
                    "application/json": {
...
app.get(
    "/cli/callback",
    describeRoute({
        operationId: "callbackCliLogin",
        summary: "CLI Login Callback",
        description: "Handle CLI login callback from Auth0",
        tags: ["Access"],
        parameters: [
            {
                name: "code",
    ...
    AccessController.callbackCliLogin
);
