...
export const createEnvRequestSchema = envBaseSchema
    .openapi({ ref: "CreateEnvRequest" });
...
export const envsResponseSchema = z
    .array(envResponseSchema)
    .openapi({ ref: "EnvsResponse" });
